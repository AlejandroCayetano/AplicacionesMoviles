...
try { 
const respuesta = await fetch (url); // Llamada a la API de Wikipedia JSON 
...
li.innerHTML = `<a href="https://es.wikipedia.org/wiki/${resultado.title}" 
target="_blank">${resultado.title} </a> - ${resultado.snippet}`; 
